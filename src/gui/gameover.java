...
public class gameover extends javax.swing.JFrame {
    ...
    // insert username and score to the score table in mathsolver database  
         String insertQuery = "INSERT INTO score (username, score) VALUES (?, ?)";
            try (PreparedStatement preparedStatement = DBconnect.connect().prepareStatement(insertQuery)) {
                ...
                System.out.println("Score stored successfully for user " );
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/game-over-gif-3.gif"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Ink Free", 1, 55)); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        leaderboard start = new leaderboard();
